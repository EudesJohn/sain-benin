-- ════════════════════════════════════════════════════════════════════════
-- SAIN — Script de traduction anglaise CORRECTE pour les colonnes _en
-- Exécuter dans l'éditeur SQL de Supabase Dashboard
-- https://supabase.com/dashboard → ton projet → SQL Editor → Run
-- ════════════════════════════════════════════════════════════════════════
-- RÈGLE : Les noms de personnes, lieux, adresses et le nom SAIN restent
--         identiques dans les deux langues. Seul le texte descriptif est
--         traduit. Les.FCFA, les montants restent identiques.
--         Les colonnes de base = français (FR)
--         Les colonnes _en = anglais (EN)
-- ════════════════════════════════════════════════════════════════════════


-- ════════════════════════════════════════════════════════════════════════
-- ÉTAPE 1 : PHOTOS — Traductions EN correctes (alt_en, caption_en)
--           Les noms de lieux/personnes restent identiques.
-- ════════════════════════════════════════════════════════════════════════

-- === Photos avec emplacement fixe ===
...
-- Équipe
UPDATE public.photos SET alt_en = 'Pascal Gbenou, SAIN founder', caption_en = 'Pascal Gbenou, founder of SAIN'
...
-- === Photos libres de la galerie (key = NULL) ===

UPDATE public.photos SET caption_en = 'Daily work at the SAIN farm'
WHERE url = '/images/Travaux-Ferme-1024x768.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Students watering the crops'
WHERE url = '/images/Ecole-Sain-Arrosage-1-1024x867.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'A student watering the vegetable garden'
WHERE url = '/images/Arrosage-Etudiant-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'The farm vegetable garden'
WHERE url = '/images/Jardin-Sain-1024x768.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Farm garden in full growth'
WHERE url = '/images/Jardin3-Sain-1024x768.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Composting, natural fertilizer source'
WHERE url = '/images/Compost-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Organic market gardening'
WHERE url = '/images/Maraichage-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Fresh vegetables from the garden'
WHERE url = '/images/Maraichage-5-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Farm market gardening'
WHERE url = '/images/Maraichage-3-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Organic market gardening'
WHERE url = '/images/Maraichage-4-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'The farm wetland'
WHERE url = '/images/Marécage-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Agricultural work on the farm'
WHERE url = '/images/Travaux-2-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Rice seedling transplanting'
WHERE url = '/images/Repiquage-Sain-1-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Transplanting seedlings in progress'
WHERE url = '/images/Repiquage-Sain-2-ppttfeo9obz73iq6nc47mek4fgqy114nz90vxbnfes.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Our SRI rice field'
WHERE url = '/images/Riz-Sain-1024x743.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Rice harvest at the farm'
WHERE url = '/images/Riz-Sain-1-1024x743.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'The farm palm grove'
WHERE url = '/images/Palme-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Farm flowers'
WHERE url = '/images/Fleur-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Our rabbit farm'
WHERE url = '/images/Elevage-lapin-Sain-1024x806.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Farm rabbits'
WHERE url = '/images/Lapins-Elevage-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Our chicken coop'
WHERE url = '/images/Elevage-Poules-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Beekeeping training'
WHERE url = '/images/Formation-Apiculture-1024x768.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Our beehives'
WHERE url = '/images/Apiculture-Formation-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Fruits from our production'
WHERE url = '/images/Fruits-Sain-1024x717.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Fresh garden fruits'
WHERE url = '/images/Fruits-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Our ripe papayas'
WHERE url = '/images/Papaye-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Turmeric, farm spice'
WHERE url = '/images/Curcuma-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Farm-grown pineapple'
WHERE url = '/images/Ananas-2-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Plantain bananas from the farm'
WHERE url = '/images/banaan-scaled-e1649512167400.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Fresh cucumber juice'
WHERE url = '/images/Jus-Concombre-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Our training farm students'
WHERE url = '/images/Etudiants-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'A student in apprenticeship'
WHERE url = '/images/Etudiant-4-1024x683.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Practical agricultural training'
WHERE url = '/images/Etudiant-5-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Practical work on the farm'
WHERE url = '/images/Etudiant-7-1024x683.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Our students together'
WHERE url = '/images/Etudiants-2-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Group of training farm students'
WHERE url = '/images/Etudiants-Sain-1024x768.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'The SAIN team together'
WHERE url = '/images/Equipe-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Smiling youth from the farm'
WHERE url = '/images/Sourire-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Our social commitment to the community'
WHERE url = '/images/Engagement-Social-Sain-1024x768.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'SAIN solidarity engagement'
WHERE url = '/images/Engagement-Social-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Farm accommodation at SAIN'
WHERE url = '/images/Hebergement-9-ppv80k18zqzr9fenf1dj1cdlvqjcdnyq13mq21ey10.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Our comfortable rooms'
WHERE url = '/images/Chambres-Sain-1024x768.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Farm accommodation area'
WHERE url = '/images/Hébergement-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Farm rooms'
WHERE url = '/images/Hébergement-3-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'The guesthouse kitchen'
WHERE url = '/images/Cuisine-Gite-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Farm kitchen'
WHERE url = '/images/Cuisine-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Warm welcome at the farm'
WHERE url = '/images/Accueil-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'The farm welcome'
WHERE url = '/images/Ferme-Accueil-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Panoramic view of the farm'
WHERE url = '/images/sain1-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Guided farm tour'
WHERE url = '/images/Visite-Ferme-ppttg268f6vd5rs1u49vuqmna3j4dgpyehc0x8ol38.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Farm tour for groups'
WHERE url = '/images/Visite-Ferme-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Canoe trip on the Ouémé River'
WHERE url = '/images/Pirogue-150x114.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Plastic sorting, eco-friendly gesture'
WHERE url = '/images/Plastique-Sain-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Our action research in agriculture'
WHERE url = '/images/Recherche-Sain-1024x767.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Laboratory research'
WHERE url = '/images/Recherche-Sain-1-pptteyp0g5dbm5de8n7jy0labwxpe6d891xmrmb4ck.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Research work'
WHERE url = '/images/Recherche-Sain-1-150x150.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'The SAIN farm as a whole'
WHERE url = '/images/A-PROPOS-SAIN-1024x715.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Portrait of a team member'
WHERE url = '/images/Reagard-ppttevvhvn9gnbhhp3zo8jawjrblr3218nz6bsfav8.jpg' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'The farm restaurant'
WHERE url = '/images/Restaurant-Sain-724x1024.png' AND key IS NULL AND caption_en = '';

UPDATE public.photos SET caption_en = 'Daily life at the farm'
WHERE url = '/images/sain5-150x150.jpg' AND key IS NULL AND caption_en = '';


-- ════════════════════════════════════════════════════════════════════════
-- ÉTAPE 2 : CIRCUITS DÉCOUVERTE — Les descriptions EN du seed étaient
--           déjà en anglais. On remet les bonnes traductions EN.
-- ════════════════════════════════════════════════════════════════════════

UPDATE public.prices SET
  title_en = 'Discovery of the local market',
  subtitle_en = 'Akpadanou Market',
  description_en = 'Immersive local market experience with guided tours and tasting of local specialties.'
WHERE key = 'circuit-1';

UPDATE public.prices SET
  title_en = 'Discovery of the village',
  subtitle_en = 'Kakanitchoé',
...
-- ════════════════════════════════════════════════════════════════════════
-- ÉTAPE 3 : HÉBERGEMENT — Chambres et pension complète
-- ════════════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════════════
-- ÉTAPE 4 : PROGRAMMES DE SOUTIEN — Traductions EN
-- ════════════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════════════
-- ÉTAPE 5 : MENUS DU RESTAURANT — Traductions EN correctes
-- ════════════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════════════
-- ÉTAPE 6 : VIDÉOS — Titres EN corrects
-- ════════════════════════════════════════════════════════════════════════
...
WHERE title = 'Sain-Benin (présentation)';

UPDATE public.videos SET title_en = 'Discovering the SAIN Training Farm in Kakanitchoé, Benin (Adjohoun-Ouémé)'
WHERE title = 'A la découverte de la Ferme école SAIN de Kakanitchoé au Bénin (Adjohoun-Ouémé)';

UPDATE public.videos SET title_en = 'The SAIN Training Farm and the Colibri Foundation'
WHERE title = 'La Ferme Ecole SAIN et la Fondation Collibri';

UPDATE public.videos SET title_en = 'The 23rd class of young entrepreneurs from SAIN Training Farm'
WHERE title = 'La 23ième promotion des jeunes entrepreneurs de la Ferme École SAIN';

UPDATE public.videos SET title_en = 'Young graduates from SAIN Training Farm share their experience'
WHERE title LIKE 'Les jeunes formés à la Ferme-école SAIN%';

UPDATE public.videos SET title_en = 'Agriculture: SAIN Training Farm in Kakanitchoé damaged by storm'
WHERE title = 'Agriculture : destruction de la Ferme École SAIN de Kakanitchoé par une tempête';

UPDATE public.videos SET title_en = 'Young entrepreneurs training — SAIN'
WHERE youtube_id = 'ebattfJkYkU';

UPDATE public.videos SET title_en = 'Farm activities — SAIN Training Farm'
WHERE youtube_id = 'jMCzuutr7yY';


-- ════════════════════════════════════════════════════════════════════════
-- ÉTAPE 7 : CONTACT INFO — Labels en français (pas de traduction EN)
--           car les labels sont des indications pour l'admin francophone.
-- ════════════════════════════════════════════════════════════════════════

-- Les labels restent en français car l'admin est en français.
-- Pas de traduction nécessaire pour contact_info.
...
SELECT COUNT(*) AS total,
  COUNT(*) FILTER (WHERE alt_en != '') AS "alt_en rempli",
  COUNT(*) FILTER (WHERE caption_en != '') AS "caption_en rempli"
FROM public.photos;

SELECT '=== CIRCUITS (EN) ===' AS section;
SELECT key, title_en, subtitle_en, LEFT(description_en, 80) || '...' AS description_en
FROM public.prices WHERE key LIKE 'circuit-%' ORDER BY key;

SELECT '=== MENUS (EN) ===' AS section;
SELECT mc.name_en AS "Catégorie", mi.name_en AS "Plat"
FROM public.menu_categories mc
JOIN public.menu_items mi ON mi.category_id = mc.id
ORDER BY mc.position, mi.position;

SELECT '=== VIDÉOS (EN) ===' AS section;
SELECT title, title_en FROM public.videos ORDER BY position;

SELECT '✅ Traductions anglaises terminées ! Les colonnes _en contiennent maintenant le vrai anglais.' AS resultat;
