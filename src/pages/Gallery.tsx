...
const Gallery = () => {
  ...
  const galleryImages = [
    ...
    { src: '/images/Jardin-Sain-150x150.jpg', alt: 'Le jardin de la ferme' },
    ...
    { src: '/images/Etudiant-7-150x150.jpg', alt: 'Formation pratique' },
    ...
    { src: '/images/Chambres-Sain-150x150.jpg', alt: 'Chambres SAIN' },
